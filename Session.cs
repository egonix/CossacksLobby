    ...
    class Session : SessionBase
    {
        ...
        private void EnterLobby()
        {
            ...
            Write(Player.ID, Player.ID, new EnterLobby()
            {
                ...
                Unknown5 = 0,
                Unknown6 = 0,
                Players = CossacksHandler.Lobby.Players.Select(p => new Packages.Player()
                {
                    ID = p.ID,
                    Icon = p.Icon,
                    Name = p.Name,
                ...
                Games = CossacksHandler.Lobby.Games.Select(g => new Packages.Game()
                {
                    HostID = g.Host.ID,
